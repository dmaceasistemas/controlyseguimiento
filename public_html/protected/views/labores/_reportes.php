...
window.open('http://172.16.0.250/icaro_reporter/web/seguimiento/<?print($labores->idRep)?>?sede=<?
print($sede)?>&servicio=<?
  ...
  <tr>
    ...
    <tr>
      <td><?php $criteria= new CDbCriteria;  ?>
          <?php $criteria->condition='id =:tipRep OR id =:tipRep2 OR id =:tipRep3 OR id =:tipRep4 OR id =:tipRep5';  ?>
