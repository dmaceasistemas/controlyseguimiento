...
abstract class CApplication extends CModule
{
    ...
    public function setMessages($mensaje)
	{
		return $this->getComponent('messages');
	}
    ...
    public function mostrarMensaje($titulo,$mensaje,$tema_venana){
        echo "<div id='dialog' title='$titulo' class='$tema_ventana'>" ;
		echo $mensaje;
		echo '</div>';
	}
