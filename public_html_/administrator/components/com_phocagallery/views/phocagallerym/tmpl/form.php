		...
		<tbody>
			...
			<?php if (count($this->images) > 0 || count($this->folders) > 0) 
			{
				...
				<tr>
					...
					<td><a href="<?php echo JRoute::_( 'index.php?option=com_phocagallery&view=phocagallerym&layout=form&hidemainmenu=1&folder='.$this->folders[$i]->path_with_name_relative_no ); ?>"><span><?php echo PhocagalleryHelper::WordDelete($this->folders[$i]->name,15); ?></span></a>
					</td>
				</tr>
				<?php endfor;
