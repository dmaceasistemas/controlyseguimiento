...
Sort By Type:<br/>
	...
	<thead>
      ...
      <tr>
        ...
        <th width="10%">Order&nbsp;&nbsp;<a href="javascript: saveorder( <?php echo count( $rows )-1; ?> )"><img src="images/filesave.png" border="0" width="16" height="16" alt="Save Order" /></a></th>
    ...
    <table cellpadding="4" cellspacing="1" border="0" width="400" class="sectionname" align="left">
      ...
      <tr>
        ...
        <script language="javascript" type="text/javascript">
          ...
          document.write('<img src=' + jsimg + ' name="imagelib2" width="240" height="180" border="2" alt="Picture Preview" />');
        ...
        <script language="javascript" type="text/javascript">
          ...
          document.write('<img src=' + jsimg + ' name="imagelib" width="120" height="90" border="2" alt="Thumbnail Preview" />');
...
##############################################################
  ...
  <div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
        ...
        <table class="adminlist">
        <tr>
                <td width="100%" class="sectionname">Gallery Categories</td>
...
<th colspan="2" nowrap="nowrap"><div align="center">Reorder</div></th>
                ...
                <td  align="center" nowrap><?php echo $row->cid; ?></td>
              <?php
                          ...
                          <td nowrap ><?php echo $Lists["catgs"]; ?></td>
                           ...
                           <tr class="row0">
                                ...
                                <td>
										...
										echo $editor->display( 'description',  $row->description , '50%', '250', '75', '20' ) ;
										//echo $editor->getButtons('description');
 ; ?>
                                </td>
                        </tr>
                                  <tr class="row1">
