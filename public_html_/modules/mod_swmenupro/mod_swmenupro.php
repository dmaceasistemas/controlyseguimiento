...
$content= "\n<!--SWmenuPro5.6J1.5 ".$menustyle." by http://www.swmenupro.com-->\n";   
...
if($menu && $id && $menustyle){
	if($css_load==2){
		...
		$content.= "<!--\n";
		$content.= "SWimportStyleSheet('".$live_site."/modules/mod_swmenupro/styles/menu".$id.".css');\n";
		$content.= "-->\n";
		$content.= "</script>\n";
	}else if($css_load==1){
    	$content.= "<link type='text/css' href='".$live_site."/modules/mod_swmenupro/styles/menu".$id.".css' rel='stylesheet' />\n";	
	}
