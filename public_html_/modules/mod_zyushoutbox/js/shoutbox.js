// Shoutbox JavaScript Document, was originally fatAjax.php
var Fat = {
...
function insertNewContent(liName,liText,lastResponse, liUrl, liId) {
	...
	Fat.fade_element("comment-new"+liId, 30, sbFadeLength, "#"+sbFadeFrom, "#"+sbFadeTo);
...
function checkName() {
	...
	if (currentName.value != jalCookie) {
		...
		document.cookie = "jalUserName="+currentName.value+expires+"; path=/";
	}
	...
	if (currentName.value == '') {
		currentName.value = 'GW_'+ Math.floor(Math.random() * 10000);
	}
...
function checkUrl() {
	...
	if (currentName.value != jalCookie) {
		...
		date.setTime(date.getTime()+(7*24*60*60*1000));
		var expires = "; expires="+date.toGMTString();
		document.cookie = "jalUrl="+currentName.value+expires+"; path=/";
		return;
	}
