...
<?php	
		...
		case 'fileupload':
?>
		<input name="<?php echo $field->name; ?>" type="file" class="ckCSSinputnormal <?php if ($field->custominfo != "") {echo "ckCSSTip";} else {echo "ckCSSnoTip";} ?>" <?php if ($field->readonly == "1") {echo ' readonly="true"';} ?> />
<?php
		break; 	
...
<?php
		...
		case 'checkbox':
?>
		<input class="ckCSStop10" name="<?php echo $field->name; ?>" id="<?php echo $field->name; ?>" type="checkbox" value="<?php echo $field->t_initvalueCB; ?>" <?php if ($field->t_checkedCB == '1') { ?> checked<?php } ?> <?php if ($field->readonly == "1") {echo ' readonly="true"';} ?> />
<?php
		break; 	
...
?>
			<input class="ckCSStop10" name="<?php echo $field->name; ?>" id="<?php echo $field->name; ?>" type="radio" value="<?php echo $key[0]; ?>" <?php echo $checked; ?> <?php if ($field->readonly == "1") {echo ' readonly="true"';} ?> />
			&nbsp;<?php echo $key[1]; ?>&nbsp;
<?php 				
			} 
