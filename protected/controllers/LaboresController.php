...
class LaboresController extends CController
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'list' and 'show' actions
				'actions'=>array('list','show', 'reportes', 'graficos','create','update','admin','delete','filtro','admin_1','prueba'),
				'users'=>array('*'),
			),
	...
	public function actionShow()
	{
        ...
        public function actionShow_Historico()
	{
		$this->render('show_historico',array('model'=>$this->loadLabores()));
	}
	
	public function actionShow_Metas()
	{
		$this->render('show_metas',array('model'=>$this->loadLabores()));
	}
	...
	public function actionCreate_Historico()
	{
		$model=new Labores;
		if(isset($_POST['Labores']))
		{
			$model->attributes=$_POST['Labores'];
			if($model->save())
                            $this->redirect(array('show_historico','id'=>$model->id));
		}
		$this->render('create_historico',array('model'=>$model));
	}

	public function actionCreate_Metas()
	{
		$model=new Labores;
		if(isset($_POST['Labores']))
		{
			$model->attributes=$_POST['Labores'];
			if($model->save())
				$this->redirect(array('show_metas','id'=>$model->id));
		}
		$this->render('create_metas',array('model'=>$model));
	}
	/**
	...
	public function actionUpdate_Historico()
	{
		$model=$this->loadLabores();
		if(isset($_POST['Labores']))
		{
		...
		$this->render('update_historico',array('model'=>$model));
	}

	public function actionUpdate_Metas()
	{
		$model=$this->loadLabores();
		if(isset($_POST['Labores']))
		{
		...
		$this->render('update_metas',array('model'=>$model));
	}	
	...
	public function actionHistorico_Admin()
	{
		$this->processAdminCommand();
		...
		$this->render('historico_admin',array(
			'models'=>$models,
			'pages'=>$pages,
			'sort'=>$sort,
		));
	...
	public function actionAdmin_Metas()
	{
		$this->processAdminCommand();
